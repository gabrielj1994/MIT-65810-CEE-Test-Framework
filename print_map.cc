...
struct DataItem *hash_table_search(DataItem** hashArray, int key) {
	if (key == 9) {
		printf("Searching for key [key=%d]", key);
	}
...
void setup_differences_whitelist() {
	...
	for (int i = 0; i < MAX_REGION_COUNT; i++) {
		...
		switch(i) {
			case 0:
				hash_table_insert(regionWhiteLists[i], 264, true);
				hash_table_insert(regionWhiteLists[i], 265, true);
				hash_table_insert(regionWhiteLists[i], 272, true);
				hash_table_insert(regionWhiteLists[i], 273, true);
				hash_table_insert(regionWhiteLists[i], 320, true);
				hash_table_insert(regionWhiteLists[i], 321, true);
				hash_table_insert(regionWhiteLists[i], 328, true);
				hash_table_insert(regionWhiteLists[i], 329, true);
				hash_table_insert(regionWhiteLists[i], 872, true);
				hash_table_insert(regionWhiteLists[i], 873, true);
				hash_table_insert(regionWhiteLists[i], 874, true);
				hash_table_insert(regionWhiteLists[i], 875, true);
				hash_table_insert(regionWhiteLists[i], 876, true);
				hash_table_insert(regionWhiteLists[i], 877, true);
				hash_table_insert(regionWhiteLists[i], 878, true);
				hash_table_insert(regionWhiteLists[i], 879, true);
				hash_table_insert(regionWhiteLists[i], 880, true);
				hash_table_insert(regionWhiteLists[i], 881, true);
				hash_table_insert(regionWhiteLists[i], 882, true);
				hash_table_insert(regionWhiteLists[i], 883, true);
				hash_table_insert(regionWhiteLists[i], 884, true);
				hash_table_insert(regionWhiteLists[i], 885, true);
				hash_table_insert(regionWhiteLists[i], 886, true);
				hash_table_insert(regionWhiteLists[i], 887, true);
				hash_table_insert(regionWhiteLists[i], 888, true);
				hash_table_insert(regionWhiteLists[i], 889, true);
				hash_table_insert(regionWhiteLists[i], 890, true);
				hash_table_insert(regionWhiteLists[i], 891, true);
				hash_table_insert(regionWhiteLists[i], 892, true);
				hash_table_insert(regionWhiteLists[i], 896, true);
				hash_table_insert(regionWhiteLists[i], 900, true);
				hash_table_insert(regionWhiteLists[i], 904, true);
				hash_table_insert(regionWhiteLists[i], 905, true);
				hash_table_insert(regionWhiteLists[i], 906, true);
				hash_table_insert(regionWhiteLists[i], 907, true);
				hash_table_insert(regionWhiteLists[i], 912, true);
				hash_table_insert(regionWhiteLists[i], 913, true);
				hash_table_insert(regionWhiteLists[i], 914, true);
				hash_table_insert(regionWhiteLists[i], 915, true);
				hash_table_insert(regionWhiteLists[i], 916, true);
				hash_table_insert(regionWhiteLists[i], 917, true);
				hash_table_insert(regionWhiteLists[i], 920, true);
				hash_table_insert(regionWhiteLists[i], 921, true);
				hash_table_insert(regionWhiteLists[i], 922, true);
				hash_table_insert(regionWhiteLists[i], 923, true);
				hash_table_insert(regionWhiteLists[i], 924, true);
				hash_table_insert(regionWhiteLists[i], 925, true);
				hash_table_insert(regionWhiteLists[i], 928, true);
				hash_table_insert(regionWhiteLists[i], 929, true);
				hash_table_insert(regionWhiteLists[i], 930, true);
				hash_table_insert(regionWhiteLists[i], 931, true);
				hash_table_insert(regionWhiteLists[i], 932, true);
				hash_table_insert(regionWhiteLists[i], 933, true);
				hash_table_insert(regionWhiteLists[i], 936, true);
				hash_table_insert(regionWhiteLists[i], 937, true);
				hash_table_insert(regionWhiteLists[i], 938, true);
				hash_table_insert(regionWhiteLists[i], 939, true);
				hash_table_insert(regionWhiteLists[i], 940, true);
				hash_table_insert(regionWhiteLists[i], 941, true);
				hash_table_insert(regionWhiteLists[i], 944, true);
				hash_table_insert(regionWhiteLists[i], 945, true);
				hash_table_insert(regionWhiteLists[i], 946, true);
				hash_table_insert(regionWhiteLists[i], 947, true);
				hash_table_insert(regionWhiteLists[i], 948, true);
				hash_table_insert(regionWhiteLists[i], 949, true);
				hash_table_insert(regionWhiteLists[i], 952, true);
				hash_table_insert(regionWhiteLists[i], 953, true);
				hash_table_insert(regionWhiteLists[i], 954, true);
				hash_table_insert(regionWhiteLists[i], 955, true);
				hash_table_insert(regionWhiteLists[i], 956, true);
				hash_table_insert(regionWhiteLists[i], 957, true);
				hash_table_insert(regionWhiteLists[i], 960, true);
				hash_table_insert(regionWhiteLists[i], 961, true);
				hash_table_insert(regionWhiteLists[i], 962, true);
				hash_table_insert(regionWhiteLists[i], 963, true);
				hash_table_insert(regionWhiteLists[i], 968, true);
				hash_table_insert(regionWhiteLists[i], 969, true);
				hash_table_insert(regionWhiteLists[i], 970, true);
				hash_table_insert(regionWhiteLists[i], 971, true);
				hash_table_insert(regionWhiteLists[i], 972, true);
				hash_table_insert(regionWhiteLists[i], 973, true);
				hash_table_insert(regionWhiteLists[i], 976, true);
				hash_table_insert(regionWhiteLists[i], 992, true);
				hash_table_insert(regionWhiteLists[i], 996, true);
				hash_table_insert(regionWhiteLists[i], 1000, true);
			case 3:
			...
			case 8:
				...
				hash_table_insert(regionWhiteLists[i], 21, true);
				...
				hash_table_insert(regionWhiteLists[i], 29, true);
				...
				hash_table_insert(regionWhiteLists[i], 37, true);
				...
				hash_table_insert(regionWhiteLists[i], 45, true);
				...
				hash_table_insert(regionWhiteLists[i], 53, true);
				...
				hash_table_insert(regionWhiteLists[i], 61, true);
				...
				hash_table_insert(regionWhiteLists[i], 69, true);
				...
				hash_table_insert(regionWhiteLists[i], 77, true);
				...
				hash_table_insert(regionWhiteLists[i], 93, true);
				...
				hash_table_insert(regionWhiteLists[i], 101, true);
				...
				hash_table_insert(regionWhiteLists[i], 109, true);
				...
				hash_table_insert(regionWhiteLists[i], 117, true);
				...
				hash_table_insert(regionWhiteLists[i], 125, true);
				...
				hash_table_insert(regionWhiteLists[i], 133, true);
				...
				hash_table_insert(regionWhiteLists[i], 141, true);
				...
				hash_table_insert(regionWhiteLists[i], 149, true);
				...
				hash_table_insert(regionWhiteLists[i], 157, true);
				...
				hash_table_insert(regionWhiteLists[i], 165, true);
				...
				hash_table_insert(regionWhiteLists[i], 173, true);
				...
				hash_table_insert(regionWhiteLists[i], 181, true);
				...
				hash_table_insert(regionWhiteLists[i], 189, true);
				...
				hash_table_insert(regionWhiteLists[i], 197, true);
				...
				hash_table_insert(regionWhiteLists[i], 205, true);
				...
				hash_table_insert(regionWhiteLists[i], 213, true);
				...
				hash_table_insert(regionWhiteLists[i], 221, true);
				...
				hash_table_insert(regionWhiteLists[i], 229, true);
				...
				hash_table_insert(regionWhiteLists[i], 237, true);
				...
				hash_table_insert(regionWhiteLists[i], 245, true);
				...
				hash_table_insert(regionWhiteLists[i], 253, true);
				...
				hash_table_insert(regionWhiteLists[i], 261, true);
				hash_table_insert(regionWhiteLists[i], 265, true);
				...
				hash_table_insert(regionWhiteLists[i], 269, true);
				hash_table_insert(regionWhiteLists[i], 273, true);
				...
				hash_table_insert(regionWhiteLists[i], 285, true);
				...
				hash_table_insert(regionWhiteLists[i], 293, true);
				...
				hash_table_insert(regionWhiteLists[i], 301, true);
				...
				hash_table_insert(regionWhiteLists[i], 309, true);
				...
				hash_table_insert(regionWhiteLists[i], 317, true);
				hash_table_insert(regionWhiteLists[i], 321, true);
				...
				hash_table_insert(regionWhiteLists[i], 325, true);
				hash_table_insert(regionWhiteLists[i], 329, true);
				...
				hash_table_insert(regionWhiteLists[i], 333, true);
				...
				hash_table_insert(regionWhiteLists[i], 341, true);
				...
				hash_table_insert(regionWhiteLists[i], 349, true);
				...
				hash_table_insert(regionWhiteLists[i], 357, true);
				...
				hash_table_insert(regionWhiteLists[i], 365, true);
				...
				hash_table_insert(regionWhiteLists[i], 373, true);
				...
				hash_table_insert(regionWhiteLists[i], 381, true);
				...
				hash_table_insert(regionWhiteLists[i], 389, true);
				...
				hash_table_insert(regionWhiteLists[i], 397, true);
				break;
			case 13:
				hash_table_insert(regionWhiteLists[i], 25, true);
				hash_table_insert(regionWhiteLists[i], 26, true);
			...
			case 14:
				...
				hash_table_insert(regionWhiteLists[i], 5, true);
				...
				hash_table_insert(regionWhiteLists[i], 413, true);
				...
				hash_table_insert(regionWhiteLists[i], 429, true);
				...
				hash_table_insert(regionWhiteLists[i], 445, true);
				...
				hash_table_insert(regionWhiteLists[i], 461, true);
...
// ./dump_busy_loop/8572/output5629db5b0000  ./dump_busy_loop/8572/output5629db5b2000
	...
	while (counter < i) {
		...
		if (str1[counter] != str2[counter]) {
			...
			if (region_index == 8 && counter == 9) {
				printf("Acknowledge collision for key [region=%d ,counter=%d]", region_index, counter);
			}
			printf("\nByte difference");
			printf("\nlocation: %d", counter);
